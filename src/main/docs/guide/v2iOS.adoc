...
[source,swift]
./complete-swift-ios-v1/IntranetClient/AnnouncementFetcher.swift
----
...
[source,swift]
./complete-swift-ios-v1/IntranetClient/AnnouncementBuilder.m
----
...
[source,swift]
./complete-swift-ios-v1/IntranetClient/AnnouncementFetcherDelegate.swift
----
